function mostrarBreadcrumb(subcategoria = null) {
    ...
    breadcrumb.innerHTML = `
        ...
        <li class="breadcrumb-item"><a href="cables-celular.html">cables para celular</a></li>
...
.then(productos => {
    ...
    const productosAudifonos = productos.filter(p => p.categoria === "cables para celular");
