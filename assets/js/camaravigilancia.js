function mostrarBreadcrumb(subcategoria = null) {
    ...
    breadcrumb.innerHTML = `
        ...
        <li class="breadcrumb-item"><a href="camaravigilancia.html">Cámara de Vigilancia</a></li>
...
.then(productos => {
    ...
    const productosAudifonos = productos.filter(p => p.categoria === "camaravigilancia");
